...
DEVICE_ID = f"python-pub-test-face-only"
...
# --- Payload Construction (Face Only Scenario) ---
payload = {
    "device_id": DEVICE_ID,
    ...
    "image": b64_image,
    "rfid_tag": None,        # NO RFID tag provided
    "rfid_detected": False,  # Indicate RFID was NOT detected
