...
# --- Configuration ---
# Use an employee's image and their correct RFID tag
...
DEVICE_ID = f"python-pub-test-auto-approve"
...
# --- Payload Construction (Auto-Approve Scenario) ---
payload = {
    "device_id": DEVICE_ID,
    ...
    "image": b64_image,
    "rfid_tag": EMPLOYEE_ID_FOR_TEST,  # Correct RFID tag for the image
    "rfid_detected": True,           # Indicate RFID was detected
    "face_detected": True,           # Indicate FACE WAS detected
}

payload_str = json.dumps(payload, separators=(",", ":"))
print(f"Total payload size: {len(payload_str)} bytes")
print(
    f"Scenario: Auto-Approve (Employee: {EMPLOYEE_ID_FOR_TEST}, RFID & Face Detected: True)")
