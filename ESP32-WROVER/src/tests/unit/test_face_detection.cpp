...
//       run face detection, and publish an "incomplete" session payload
//       (image + face detection status) to MQTT.
...
void runFaceDetectionTest()
{
    ...
    jsonDoc["rfid_detected"] = false; // Explicitly false for this test
