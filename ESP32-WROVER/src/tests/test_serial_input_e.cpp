...
const int ESP32_RX_PIN = 18; // Connect this to Mega TX (Pin 16)
const int ESP32_TX_PIN = 19; // Connect this to Mega RX (Pin 17)
...
void setup() {
  ...
  Serial.print("(RX="); Serial.print(ESP32_RX_PIN);
  Serial.print(", TX="); Serial.print(ESP32_TX_PIN);
  Serial.print(") at ");
